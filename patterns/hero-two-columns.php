...
<h2 class="wp-block-heading has-x-large-font-size" id="text-on-left-image-on-right"><?php echo esc_html__( 'Welcome to Lokal Base', 'lokal' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Get Started', 'lokal' ); ?></a></div>
<!-- /wp:button -->
